...
defaults write com.apple.dock wvous-tl-modifier -int 0  # start screen saver

# Top right screen corner - disable screen saver
defaults write com.apple.dock wvous-tr-corner -int 6  # disable screen saver
defaults write com.apple.dock wvous-tr-modifier -int 0  # disable screen saver

# Bottom left screen corner → Display to sleep
defaults write com.apple.dock wvous-bl-corner -int 3  # application windows
defaults write com.apple.dock wvous-bl-modifier -int 0  # application windows

# Bottom right screen corner
defaults write com.apple.dock wvous-br-corner -int 4  # show desktop
defaults write com.apple.dock wvous-br-modifier -int 0  # show desktop
